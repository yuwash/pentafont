...
var makeTransform = function makeTransform(x, y, width, height) {
...
var etaionsparsePentagonPolygons = [[[3, 1], [4, 3], [5, 2], [5, 1], [4, 0]], [[0, 2], [0, 4], [2, 6], [4, 3], [2, 0]], [[3, 5], [4, 7], [5, 6], [5, 4], [4, 3]], [[0, 6], [0, 8], [2, 10], [4, 7], [2, 4]], [[3, 9], [4, 10], [5, 9], [5, 8], [4, 7]]];

var renderByteEtaionsparsePentagon = function renderByteEtaionsparsePentagon(byte_, x, y, width, height) {
  return renderByte(function (bit, x, y, width, height) {
